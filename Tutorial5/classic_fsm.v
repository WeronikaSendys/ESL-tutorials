...
reg chunk_insts_2_prev_button;
reg chunk_insts_2_button_o;
reg [16:0] chunk_insts_2_debounce_cnt;
wire [1:0] chunk_insts_2_chunk_insts_1_a;

assign chunk_insts_2_chunk_insts_1_a[1] = chunk_insts_0_button_o;
assign chunk_insts_2_chunk_insts_1_a[0] = chunk_insts_2_button_o;
...
always @(posedge clk_i) begin: CLASSIC_FSM_LOC_INSTS_CHUNK_INSTS_0_LOC_INSTS_CHUNK_INSTS_K
    if ((inputs_i[1] == chunk_insts_0_prev_button)) begin
        if ((chunk_insts_0_debounce_cnt != 0)) begin
    ...
    chunk_insts_0_prev_button <= inputs_i[1];
end



assign dbnc_inputs = chunk_insts_2_chunk_insts_1_a;


always @(posedge clk_i) begin: CLASSIC_FSM_LOC_INSTS_CHUNK_INSTS_2_LOC_INSTS_CHUNK_INSTS_0
    if ((inputs_i[0] == chunk_insts_2_prev_button)) begin
        if ((chunk_insts_2_debounce_cnt != 0)) begin
            chunk_insts_2_debounce_cnt <= (chunk_insts_2_debounce_cnt - 1);
        end
    end
    else begin
        chunk_insts_2_debounce_cnt <= 120000;
    end
    chunk_insts_2_prev_button <= inputs_i[0];
end


always @(posedge clk_i) begin: CLASSIC_FSM_LOC_INSTS_CHUNK_INSTS_2_LOC_INSTS_CHUNK_INSTS_K
    if ((chunk_insts_2_debounce_cnt == 0)) begin
